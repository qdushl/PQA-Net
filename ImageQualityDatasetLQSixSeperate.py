...
class ImageQualityDatasetLQSixSeperate(Dataset):
    def __init__(self, csv_file_dist, csv_file_mos, root_dir_dist, root_dir_mos, enable_dist, transform=None,
                 train=None,
                 num_plane=6):
        self.enable_dist = enable_dist
    ...
    def __getitem__(self, idx):
        ...
        transformhorizonflip = transforms.Compose([
            transforms.RandomHorizontalFlip(0.5),
        ]
        )
        transformvertiaclflip = transforms.Compose([
        ...
        for i in range(self.num_plane):
            ...
            if self.transform:
                ...
                images_arr_temp[i, :, :, :] = transformtensor(image_arr_temp[i, :, :, :])
            else:
       ...
       #a,b,c,d,e,f=s.split(6,dim=0)
        #a,b,c,d,e,f=s.chunk(6,dim=0)
